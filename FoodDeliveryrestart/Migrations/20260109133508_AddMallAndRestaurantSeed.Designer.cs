...
namespace FoodDeliveryrestart.Migrations
{
    ...
    [Migration("20260109133508_AddMallAndRestaurantSeed")]
    partial class AddMallAndRestaurantSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodDeliveryrestart.Domain.PaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardType = "Visa",
                            CreatedBy = "Seed",
                            DateCreated = new DateTime(2026, 1, 9, 13, 35, 6, 724, DateTimeKind.Utc).AddTicks(9302),
                            DateUpdated = new DateTime(2026, 1, 9, 13, 35, 6, 724, DateTimeKind.Utc).AddTicks(9307),
                            ExpiryMonth = 12,
                            ExpiryYear = 2026,
                            UpdatedBy = "Seed",
                            UserId = 1
                        ...
                        new
                        {
                            ...
                            CardType = "MasterCard",
                            CreatedBy = "Seed",
                            DateCreated = new DateTime(2026, 1, 9, 13, 35, 6, 724, DateTimeKind.Utc).AddTicks(9313),
                            DateUpdated = new DateTime(2026, 1, 9, 13, 35, 6, 724, DateTimeKind.Utc).AddTicks(9314),
                            ExpiryMonth = 10,
                            ExpiryYear = 2025,
                            UpdatedBy = "Seed",
                            UserId = 1
                        ...
                        new
                        {
                            ...
                            CardType = "AMEX",
                            CreatedBy = "Seed",
                            DateCreated = new DateTime(2026, 1, 9, 13, 35, 6, 724, DateTimeKind.Utc).AddTicks(9318),
                            DateUpdated = new DateTime(2026, 1, 9, 13, 35, 6, 724, DateTimeKind.Utc).AddTicks(9319),
                            ExpiryMonth = 6,
                            ExpiryYear = 2027,
                            UpdatedBy = "Seed",
                            UserId = 1
            ...
            modelBuilder.Entity("FoodDeliveryrestart.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Seed",
                            DateCreated = new DateTime(2026, 1, 9, 21, 35, 6, 725, DateTimeKind.Local).AddTicks(157),
                            DateUpdated = new DateTime(2026, 1, 9, 21, 35, 6, 725, DateTimeKind.Local).AddTicks(158),
                            Email = "seed@food.com",
                            Name = "Seed User",
