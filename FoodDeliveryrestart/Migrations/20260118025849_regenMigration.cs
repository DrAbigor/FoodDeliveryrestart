    ...
    public partial class regenMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupOrderRestaurant", x => new { x.GroupOrderId, x.RestaurantId });
                    table.ForeignKey(
                        name: "FK_GroupOrderRestaurant_GroupOrder_GroupOrderId",
                        column: x => x.GroupOrderId,
                        principalTable: "GroupOrder",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupOrderRestaurant_Restaurant_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurant",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupOrderRestaurant_RestaurantId",
                table: "GroupOrderRestaurant",
                column: "RestaurantId");
